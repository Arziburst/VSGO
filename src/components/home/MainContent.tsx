  ...
  return (
    <PageShell>
      ...
      <PageCard tone="soft" className="p-5 md:p-6">
        <ContentTitle className="mb-3 normal-case">Шановні друзі!</ContentTitle>
        <div className="space-y-3 text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <p>
            Internet є невід&apos;ємною частиною інвалідного руху в усьому
            світі. Ми також вирішили приділити особливу увагу цьому процесу. І
            сьогодні нами зроблено ще один крок, спрямований на покращення
            спілкування та обміну інформацією між інвалідами в кожному куточку
            нашої країни та далеко за її межами. Сподіваємось, що наш ресурс
            стане корисним джерелом цікавої та актуальної інформації.
          </p>
        </div>
      </PageCard>

      <div>
        <ContentTitle className="mb-4 tracking-wide">
